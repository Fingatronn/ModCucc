...
public class Alloysmelterlvl2guiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public Alloysmelterlvl2guiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ProbModMenus.ALLOYSMELTERLVL_2GUI.get(), id);
