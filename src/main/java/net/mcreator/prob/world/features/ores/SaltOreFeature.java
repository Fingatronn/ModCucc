...
import net.mcreator.prob.procedures.SaltBlockAdditionalGenerationConditionProcedure;
...
public class SaltOreFeature extends OreFeature {
	...
	public boolean place(FeaturePlaceContext<OreConfiguration> context) {
		...
		if (!SaltBlockAdditionalGenerationConditionProcedure.execute(world, x, y, z))
			return false;
