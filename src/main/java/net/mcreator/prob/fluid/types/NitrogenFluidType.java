...
public class NitrogenFluidType extends FluidType {
	public NitrogenFluidType() {
		super(FluidType.Properties.create().fallDistanceModifier(0F).canExtinguish(true).supportsBoating(true).canHydrate(true).density(-1000)
