...
public class OilrefScreen extends AbstractContainerScreen<OilrefMenu> {
	private final static HashMap<String, Object> guistate = OilrefMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public OilrefScreen(OilrefMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("prob:textures/screens/oilref.png");
