...
public class AlloyFurneaceScreen extends AbstractContainerScreen<AlloyFurneaceMenu> {
	private final static HashMap<String, Object> guistate = AlloyFurneaceMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public AlloyFurneaceScreen(AlloyFurneaceMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("prob:textures/screens/alloy_furneace.png");
