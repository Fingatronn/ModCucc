...
public class PumpBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public PumpBlockEntity(BlockPos position, BlockState state) {
		super(ProbModBlockEntities.PUMP.get(), position, state);
	}
	...
	public Component getDisplayName() {
		return Component.literal("Oil Pump");
	}
