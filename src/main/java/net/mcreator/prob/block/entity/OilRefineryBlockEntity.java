...
public class OilRefineryBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(8, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public OilRefineryBlockEntity(BlockPos position, BlockState state) {
		super(ProbModBlockEntities.OIL_REFINERY.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("oil_refinery");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new OilrefMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
